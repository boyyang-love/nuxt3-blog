  ...
  <span class="IconContainer">
    ...
    >
      <circle
          ...
          cx="129.5"
      ></circle>
      <circle fill="var(--font-color)" r="18.5" cy="18.5" cx="129.5"></circle>
      <circle fill="var(--font-color)" r="18.5" cy="51.5" cx="206.5"></circle>
      <circle fill="var(--font-color)" r="18.5" cy="129.5" cx="240.5"></circle>
      <circle fill="var(--font-color)" r="18.5" cy="207.5" cx="207.5"></circle>
      <circle fill="var(--font-color)" r="18.5" cy="206.5" cx="52.5"></circle>
      <circle fill="var(--font-color)" r="18.5" cy="240.5" cx="129.5"></circle>
      <circle fill="var(--font-color)" r="18.5" cy="129.5" cx="18.5"></circle>
      <circle fill="var(--font-color)" r="18.5" cy="50.5" cx="51.5"></circle>
      <line
          stroke-width="8"
          stroke="var(--font-color)"
          y2="78.7279"
    ...
    <svg
        ...
        class="svgFG"
    >
      <circle stroke-width="28" stroke="var(--font-color)" r="32" cy="55" cx="55"></circle>
      <path
          fill="var(--font-color)"
